...
import DeleteSub from "../../../subscriptions/components/DeleteSub";
import RenewalSub from "../../../subscriptions/components/RenewalSub";
import ActivationSub from "../../../subscriptions/components/ActivationSub";
      ...
      <MainCard border={false} sx={{ height: "100%" }}>
        ...
        <Stack flexDirection="row" alignItems="center" gap={1}>
          ...
          <Permission permission="orders.update">
            <RenewalSub sub={subscription} />
            <ActivationSub sub={subscription} />
          </Permission>
        </Stack>
      </MainCard>
    </div>
